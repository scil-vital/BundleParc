...
srun python scripts/bundleparc_train.py bundleparc hcp105 hcp1200_pretrain_1_xl $SCRATCH/braindata/bundleparc/hcp1200_pretrain.hdf5  --batch-size 1 --epochs 1000 --lr 0.0001 --devices 4 --wm_drop_ratio 1 --prompt_strategy attention --volume_size 128 --warmup 50 --pretrain --nodes 2
